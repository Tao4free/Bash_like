...
let s:pink = {'gui': '#d75fd7', 'cterm256': '170'}
let s:green = { 'gui': '#87d787', 'cterm256': '114'}
let s:dark_green = { 'gui': '#5faf00', 'cterm256': '70'}
let s:light_green = { 'gui': '#00ffd7', 'cterm256': '50'}
let s:yellow = { 'gui': '#e5c07b', 'cterm256': '180'}
let s:whisky = { 'gui': '#d19a66', 'cterm256': '173' }
let s:blue = { 'gui': '#61afef', 'cterm256': '39'}
let s:light_blue = { 'gui': '#8fafd7', 'cterm256': '110'}
...
let s:grey = { 'gui': '#abb2bf', 'cterm256': '246' } " 59
...
call <sid>hi('LineNr', s:grey, s:background, 'none', {})
...
call <sid>hi('Pmenu', s:black, s:pink, 'none', {})
call <sid>hi('PmenuSel', s:black, s:green, 'none', {})
...
call <sid>hi('StatusLineNC', s:background, s:background, 'none', {})
...
"----------------------------------------------------
" {{{
call <sid>hi('Comment', s:background, s:yellow, 'italic', {})
call <sid>hi('pythonComment', s:background, s:dark_green, 'italic', {})
...
call <sid>hi('Function', s:yellow, s:none, 'none', {})
call <sid>hi('pythonFunction', s:yellow, s:none, 'none', {})

call <sid>hi('Statement', s:pink, s:none, 'none', {})
call <sid>hi('pythonBuiltin', s:blue, s:none, 'none', {})

call <sid>hi('PreProc', s:whisky, s:none, 'none', {})

call <sid>hi('Structure', s:light_green, s:none, 'none', {})

call <sid>hi('Conditional', s:pink, s:none, 'none', {})
call <sid>hi('Include', s:pink, s:none, 'none', {})
call <sid>hi('Repeat', s:pink, s:none, 'none', {})
call <sid>hi('Exception', s:pink, s:none, 'none', {})
call <sid>hi('pythonStatement', s:pink, s:none, 'none', {})
" put https://github.com/kuroitu/vim_item/python.vim
" ~/.vim/syntax/
call <sid>hi('pythonOperator', s:pink, s:none, 'none', {})
call <sid>hi('pythonOperatorSymbol', s:white, s:none, 'none', {})
